...
class KaoShi_CET6Controller extends Controller
{
   public function handle_request(){
       ...
       $datalist=$bllcet->getListPyPage(2,$from,$pageSize);
       $listcnt=$bllcet->getCnt(2);
       ...
       $req->set_attribute("type","cet6");
       $req->set_attribute("pageinfo",array("page"=>$page,"pageCnt"=>$pageCnt,"frompage"=>$frompage,"endpage"=>$endpage,"uri"=>'/kaoshi/cet6'));
       return "KaoShi_Home";
   }
}
